            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="code" header="Employee ID" sortable body={codeBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column field="name" header="Name" sortable body={nameBodyTemplate} headerStyle={{ minWidth: '15rem' }}></Column>
                        <Column header="Image" body={imageBodyTemplate}></Column>
                        <Column field="price" header="Email" body={priceBodyTemplate} sortable></Column>
                        <Column field="category" header="Phone" sortable body={categoryBodyTemplate} headerStyle={{ minWidth: '10rem' }}></Column>
                        <Column field="rating" header="Designation" body={ratingBodyTemplate} sortable></Column>
